...
public class UserControllerTest {
    ...
    public void shouldThrowException() {
        ...
        UserController controller = new UserController(storage, userService);
        ...
        final CustomValidateException exp1 = assertThrows(
                ...
                () -> controller.getInMemoryUserStorage().validate(user1)
        );
        ...
        final CustomValidateException exp2 = assertThrows(
                CustomValidateException.class,
                () -> controller.getInMemoryUserStorage().validate(user2)
        );
        ...
        final CustomValidateException exp3 = assertThrows(
                CustomValidateException.class,
                () -> controller.getInMemoryUserStorage().validate(user3)
        );
