...
public class FilmService {
    ...
    public void addLike(InMemoryFilmStorage inMemoryFilmStorage, InMemoryUserStorage inMemoryUserStorage, Integer filmId, Integer userId) {
        inMemoryFilmStorage.getFilmHashMap().get(filmId).getLikes().put(userId, inMemoryUserStorage.getMapOfUser().get(userId));
    }
    ...
    public ArrayList<Film> topFilms(InMemoryFilmStorage inMemoryFilmStorage, int count) {
